		...
		return (
			<div className="active-race">
				<div className="race-track">
					<div className="racer work">
						<span>Work</span>
						<div
							className="racer-bar"
							style={{ animationDuration: `${task.workDurationMs}ms` }}
						/>
					</div>
					<div className="racer timeout">
						<span>Timeout</span>
						<div
							className="racer-bar"
							style={{ animationDuration: `${task.timeoutMs}ms` }}
						/>
					</div>
				</div>
			</div>
	...
	return (
		<div className={`transaction-card ${tx.status}`}>
			...
			<div className="tx-steps">
				{tx.steps.map((step) => (
					<div key={step.name} className="tx-step">
						<span
							className="step-dot"
